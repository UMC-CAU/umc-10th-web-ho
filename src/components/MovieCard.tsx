...
export default function MovieCard({movie}:MovieCardProps) {
    ...
    return (
        <div className='relative rounded-xl shadow-lg overflow-hidden cusrsor-pointer w-44
        ...
        >
            ...
            {isHovered && (
                ...
                justify-center item-center text-white p-4'>
